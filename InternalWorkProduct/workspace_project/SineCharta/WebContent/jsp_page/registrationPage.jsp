...
<div class="container">
    ...
    <form class="form-horizontal" method="post" action="/UsersCotrol" style="border: 1px solid red; padding: 3%; border-radius: 1%">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="surname" class="form-control" id="surname"
                               placeholder="your surname" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-success" value="Register"><i class="fa fa-user-plus"></i> Register</button>
            </div>
    </form>
</div>

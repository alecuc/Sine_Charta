...
public class PersonaggioManager {
	...
	public Personaggio getPersonaggio(int idPG) throws SQLException{
		...
		try {
			...
			while(rs.next()) {
				...
				personaggio.setAge(rs.getInt("Età"));
				personaggio.setNazionalita(rs.getString("Nazionalità"));
				...
				personaggio.setAffinOcculta(rs.getInt("AffinitàOcculta"));
	...
	public void creaPersonaggio(Personaggio pg, int idPG) throws SQLException{
		...
		String aggiungiPG = "INSERT INTO "+ TABLE_NAME_PG+" (NOME, COGNOME, ETà, NAZIONALITà, TAROCCODOMINANTE, "
				+ "INTUITO, ASPETTO, COORDINAZIONE, AFFINITàOCCULTA, MEMORIA, COMANDO, DESTREZZAMANUALE, DISTANZADALLAMORTE,"
				+ " PERCEZIONE, CREATIVITà, FORZAFISICA, EQUILIBRIOMENTALE, VOLONTà, SOCIEVOLEZZA, MIRA, KARMA, RISOLUZIONE, "

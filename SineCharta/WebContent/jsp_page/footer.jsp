				...
				<div class="container">
					<div id="accordion">
						<div class="card">
							<div class="card-header">
								<a class="card-link" data-toggle="collapse" href="#collapseOne"
									style="color: red;"> Che cos'è Sine Charta? </a>
							</div>
							<div id="collapseOne" class="collapse" data-parent="#accordion">
								<div class="card-body">
									<p>
										<em>Sine Charta</em> è un'applicazione web per la gestione
										virtuale di <em>Sine Requie</em> Sine Requie è un gioco di
										ruolo horror italiano, scritto da Matteo Cortini e Leonardo
										Moretti e pubblicato nel 2003 nella sua prima edizione da
										RosePoison. La seconda edizione è stata prodotta da Asterion
						...
						<div class="card">
							<div class="card-header">
								<a class="collapsed card-link" data-toggle="collapse"
									href="#collapseThree" style="color: red;"> A chi è rivolto?
								</a>
							</div>

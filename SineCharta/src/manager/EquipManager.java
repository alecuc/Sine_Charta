...
public class EquipManager {
	 ...
	 * @param oggetto= ï¿½ l'oggetto da inserire.
	 * @param idPersonaggio= ï¿½ l'identificativo del personaggio a cui aggiungere l'oggetto.
	...
	/**
	 * Metodo che rimuove un oggetto in base a ID del personaggio a cui ï¿½ associato
